...
export async function before(m, {conn, isAdmin, isBotAdmin, usedPrefix}) {
  ...
  const fakemek = {'key': {'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net'}, 'message': {'groupInviteMessage': {'groupJid': '5493711419816-5493711419816@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐃𝐢𝐞𝐠𝐨-𝐀𝐃', 'jpegThumbnail': null}}};
