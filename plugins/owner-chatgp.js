...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('5493711419554-5493711419554@g.us' ? {remoteJid: '5493711419554-5493711419554@g.us'} : {})}, message: {'videoMessage': {'title': '🐱⸽⃕NʏᴀɴCᴀᴛBᴏᴛ - MD🍁⃨፝⃕✰', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '🧿 𝐃𝐢𝐞𝐠𝐨-𝐀𝐃 🔮', 'jpegThumbnail': false}}};
